    ...
    public static class ReplyFactory
    {
        ...
        public static Attachment CreateGoogleMapCard(double[] incoords, dynamic w3wResult = null)
        {
            ...
            var buttons = new List<CardAction> {
                new CardAction(ActionTypes.OpenUrl, "Open", value: "https://www.google.com/maps/place/" + incoords[0] + "+" + incoords[1] + "/@" + incoords[0] + "+" + incoords[1] + ",18z"),
            };
        ...
        public static Attachment CreateGoogleStreetViewCard(double[] incoords)
        {
            ...
            var buttons = new List<CardAction> {
                new CardAction(ActionTypes.OpenUrl, "Open", value: "https://www.google.com/maps/@?api=1&map_action=pano&viewpoint=" + incoords[0] + "," + incoords[1] + "&fov=90&heading=235&pitch=10"),
            };
        ...
        public static Attachment CreateGoogleEarthCard(double[] incoords)
        {
            ...
            var buttons = new List<CardAction> {
                new CardAction(ActionTypes.OpenUrl, "Open", value: "https://earth.google.com/web/@" + incoords[0] + "," + incoords[1] + ",146.726a,666.616d,35y,0h,45t,0r")
            };
