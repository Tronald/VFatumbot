namespace VFatumbot.BotLogic
{
    public class Consts
    {
        ...
        public const string NO_LOCATION_SET_MSG = "You haven't set a location. Send your location from (hint: you can do so by tapping the 🌍/::/＋/📎 icon in your app), or you can send a [Google Maps URL](https://www.google.com/maps/@51.509865,-0.118092,13z). Don't forget you can type \"help\" for more info.";
    }
}
