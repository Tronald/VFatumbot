...
namespace Imgur.API.Authentication.Impl
{
  ...
  /// </summary>
  public class MashapeClient : ApiClientBase, IMashapeClient, IApiClient
  {
    /// <summary>
    ...
    ///     valid argument.
    /// </exception>
    public MashapeClient(string clientId, string mashapeKey)
      : base(clientId)
    {
    ...
    /// <summary>The Mashape Key.</summary>
