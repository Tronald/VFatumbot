...
{
  /// <summary>The data model formatted for gallery images.</summary>
  public class GalleryImage : GalleryItem, IGalleryImage, IGalleryItem, IDataModel
  {
    /// <summary>The account ID for the uploader, or null.</summary>
    ...
    /// <summary>Is the image animated.</summary>
    public virtual bool Animated { get; set; }

    /// <summary>Bandwidth consumed by the image in bytes.</summary>
    ...
    /// <summary>The ID for the image.</summary>
