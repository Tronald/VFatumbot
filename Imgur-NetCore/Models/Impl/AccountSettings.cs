...
namespace Imgur.API.Models.Impl
{
  ...
  public class AccountSettings : IAccountSettings, IDataModel
  {
    ...
    public virtual IEnumerable<IBlockedUser> BlockedUsers { get; set; } = (IEnumerable<IBlockedUser>) new List<IBlockedUser>();
