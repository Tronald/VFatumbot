...
{
  /// <summary>A notification of a new message.</summary>
  public class MessageNotification : IMessageNotification, IDataModel
  {
    /// <summary>Account ID of the user in conversation.</summary>
    ...
    /// <summary>The username of the other user in conversation.</summary>
    public virtual string From { get; set; }

    /// <summary>Conversation ID</summary>
    public virtual int Id { get; set; }

    /// <summary>The last message</summary>
