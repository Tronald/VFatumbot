...
{
  /// <summary>A notification of a new comment.</summary>
  public class CommentNotification : ICommentNotification, IComment, IDataModel
  {
    /// <summary>
    ...
    /// <summary>Username of the author of the comment.</summary>
    public virtual string Author { get; set; }

    /// <summary>The account ID for the author.</summary>
    ...
    public virtual IEnumerable<IComment> Children { get; set; } = (IEnumerable<IComment>) new List<IComment>();

    /// <summary>The comment itself.</summary>
    ...
    /// <summary>Marked true if this caption has been deleted.</summary>
    public virtual bool Deleted { get; set; }

    /// <summary>The number of downvotes for the comment.</summary>
    public virtual int? Downs { get; set; }

    /// <summary>The ID for the comment.</summary>
    public virtual int Id { get; set; }

    /// <summary>The Id of the image that the comment is for.</summary>
    [JsonProperty("image_id")]
    public virtual string ImageId { get; set; }

    /// <summary>If this comment was done to an album.</summary>
    ...
    /// <summary>The number of upvotes - downvotes.</summary>
    public virtual float Points { get; set; }

    /// <summary>Number of upvotes for the comment.</summary>
