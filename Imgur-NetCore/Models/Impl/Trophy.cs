...
namespace Imgur.API.Models.Impl
{
  ...
  public class Trophy : ITrophy, IDataModel
  {
    /// <summary>
    ...
    /// <summary>A link to where the trophy was earned.</summary>
    ...
    /// <summary>URL of the image representing the trophy.</summary>
    public virtual string Image { get; set; }

    /// <summary>The name of the trophy.</summary>
    public virtual string Name { get; set; }

    /// <summary>Can be thought of as the ID of a trophy type.</summary>
