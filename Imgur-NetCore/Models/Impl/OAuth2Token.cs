...
{
  /// <summary>The response from an OAuth2 Token request.</summary>
  public class OAuth2Token : IOAuth2Token
  {
    ...
    /// <summary>The user's account id.</summary>
    [JsonProperty("account_id")]
    public virtual string AccountId { get; }

    /// <summary>The user's account username.</summary>
    ...
    public virtual DateTimeOffset ExpiresAt
    {
      get
      {
        return DateTimeOffset.UtcNow.AddSeconds((double) this.ExpiresIn);
      }
    }
