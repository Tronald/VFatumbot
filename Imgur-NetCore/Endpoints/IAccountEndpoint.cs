...
namespace Imgur.API.Endpoints
{
  ...
  public interface IAccountEndpoint : IEndpoint
  {
    ...
    /// <summary>Deletes an Image. OAuth authentication required.</summary>
    ...
    /// <returns></returns>
    Task<IEnumerable<IGalleryItem>> GetAccountGalleryFavoritesAsync(
      string username = "me",
      int? page = null,
    ...
    /// <param name="page">Set the page number so you don't have to retrieve all the data at once. Default: null</param>
    /// <returns></returns>
    Task<IEnumerable<IGalleryItem>> GetAccountSubmissionsAsync(
      string username = "me",
      int? page = null);
    ...
    /// <returns></returns>
    Task<IEnumerable<int>> GetCommentIdsAsync(
      string username = "me",
