...
namespace Imgur.API.Endpoints
{
  ...
  public interface IGalleryEndpoint
  {
    ...
    /// <returns></returns>
    Task<int> CreateGalleryItemCommentReplyAsync(
      string comment,
    ...
    /// <returns></returns>
    Task<IEnumerable<IGalleryItem>> GetGalleryAsync(
    ...
    /// <returns></returns>
    Task<IEnumerable<IComment>> GetGalleryItemCommentsAsync(
      string galleryItemId,
    ...
    /// <param name="page">The data paging number. Default: null</param>
    /// <returns></returns>
    Task<IEnumerable<IGalleryImage>> GetSubredditGalleryAsync(
      string subreddit,
    ...
    /// <returns></returns>
    Task<bool> PublishToGalleryAsync(
      string galleryItemId,
      string title,
      string topicId = null,
    ...
    /// <param name="page">The data paging number. Default: null</param>
    /// <returns></returns>
    Task<IEnumerable<IGalleryItem>> SearchGalleryAsync(
      string query,
      GallerySortOrder? sort = GallerySortOrder.Time,
      TimeWindow? window = TimeWindow.All,
      int? page = null);
